	...
	if (level == MARIO_LEVEL_BIG)
	{
		...
		else
		{
			if (isJumping == false)
			{
				...
				else if (MARIO_WALKING_SPEED < abs(vx) && abs(vx) < 0.3f)
...
void CMario::SetState(int state)
{
	...
	//	//	vx = MARIO_VMAX * nx;
	//	break;
	//case MARIO_STATE_SKID_LEFT:
	//	isWalkingComplete == true;
	//	nx = -1;
	//	break;
	//case MARIO_STATE_SKID_RIGHT:
	//	isWalkingComplete == true;
	//	nx = 1;
	//	break;
	}
